...
def process_physionet_data(input_path, output_dir="/home/antonxue/shailesh/MCal/data/tabular/missingness_levels", from_txt=False, dataset='set-a'):
    """
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="missingness_levels",
